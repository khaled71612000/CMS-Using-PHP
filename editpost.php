...
elseif(strlen($Title) < 2) {
   ...
   redirect("addnewpost.php");
    ...
    category='$Category',author = '$Admin',image='$Image',post = '$Post' WHERE id ='$EditFromUrl' ";
...
<!-- when updated post edit the source and pass it  -->
        <form action="EditPost.php?Edit=<?php echo $Parameter ?>" method="post" enctype="multipart/form-data">
        <div class="form-group">        
            <label for="title">Title:</label>
            <input value = "<?php echo $Title ?>" class="form-control" type="text" name="Title" placeholder="Title" id="title">
        </div>
        <div class="form-group">  
